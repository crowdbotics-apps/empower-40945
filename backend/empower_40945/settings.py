"""
Django settings for empower_40945 project.
...
ROOT_URLCONF = 'empower_40945.urls'
...
WSGI_APPLICATION = 'empower_40945.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "empower_40945 API",
    "DESCRIPTION": "API documentation for empower_40945 App",
    "VERSION": "v1",
}
